...
namespace Basket.Infrastructure.Migrations
{
    ...
    [Migration("20220708191146_made corrects into basketItem")]
    partial class madecorrectsintobasketItem
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BasketItemCustomerBasket", b =>
                {
                    b.Property<Guid>("GetCustomerBasketsCustomerId")
                        .HasColumnType("uuid");

                    b.Property<Guid>("GetItemsId")
                        .HasColumnType("uuid");

                    b.HasKey("GetCustomerBasketsCustomerId", "GetItemsId");

                    b.HasIndex("GetItemsId");

                    b.ToTable("BasketItemCustomerBasket");
                });

            modelBuilder.Entity("BasketItemCustomerBasket1", b =>
                {
                    ...
                    b.ToTable("BasketItemCustomerBasket1");
                });
            ...
            modelBuilder.Entity("BasketItemCustomerBasket", b =>
                {
                    b.HasOne("Basket.Domain.Entities.CustomerBasketNS.CustomerBasket", null)
                        .WithMany()
                        .HasForeignKey("GetCustomerBasketsCustomerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Basket.Domain.Entities.BasketItemNS.BasketItem", null)
                        .WithMany()
                        .HasForeignKey("GetItemsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
